  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white selection:bg-[#1DB954]/30 selection:text-white relative">
      ...
      <div className="relative z-10">
        ...
        {/* Hero Banner Section */}
        <div className="relative bg-[#181818] border border-[#333333] rounded-[2rem] overflow-hidden mb-20 shadow-2xl py-16 px-8 sm:px-16 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
            {[
              ...
              <button
                ...
                className="w-full aspect-square bg-[#181818] border border-[#333333] rounded-[2rem] flex flex-col items-center justify-center gap-3 hover:bg-[#282828] hover:border-[#1DB954]/50 transition group"
              >
        ...
        {trendingData && trendingData.length > 0 && (
          <div className="mb-10 bg-[#181818] border border-[#333333] rounded-3xl p-6 shadow-2xl ">
        ...
        <div className="mt-32 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#181818] border border-[#333333] p-8 rounded-[2rem] hover:border-[#1DB954]/50 transition group">
